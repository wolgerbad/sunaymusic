...
export const metadata = {
  title: 'Mastering - Sunay Music Stüdyo',
  description:
    'Sunay Music Stüdyo mastering sayfası. Mastering sürecimiz ve hizmet detaylarımız hakkında bilgi alın.',
};
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="rounded-2xl border border-white/10 bg-white/4 p-6 md:p-8 backdrop-blur-sm">
            <h2 className="text-2xl md:text-3xl font-semibold">
              Profesyonel Mastering Süreci
            </h2>
            <p className="mt-4 text-white/75 leading-relaxed max-w-5xl">
              Sunay Music Studio&apos;da mastering oturumları, şarkının tarzına
              ve vokal/performans ihtiyacina gore planlanır. Amacımız, doğal
